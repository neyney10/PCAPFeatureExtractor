...
class NPacketsByteFrequency(NFPlugin):
    ...
    def on_expire(self, flow):
        ...
        flow.udps.bidirectional_n_packets_byte_frequency /= np.sum(flow.udps.bidirectional_n_packets_byte_frequency)
        flow.udps.src2dst_n_packets_byte_frequency       /= np.sum(flow.udps.src2dst_n_packets_byte_frequency)
        flow.udps.dst2src_n_packets_byte_frequency       /= np.sum(flow.udps.dst2src_n_packets_byte_frequency)
        # Compute statistical features
        # bidirectional
        bidirectional_stats = IterableStats(flow.udps.bidirectional_n_packets_byte_frequency)
        ...
        # src -> dst
        src2dst_stats = IterableStats(flow.udps.src2dst_n_packets_byte_frequency)
        ...
        # dst -> src
        dst2src_stats = IterableStats(flow.udps.dst2src_n_packets_byte_frequency)

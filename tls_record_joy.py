...
class TLSRecordJoy():
    ...
    def _read_joy_config_file(self):
        text_config = open(self.config_filepath)
        json_config = json.loads(text_config.read())
        return json_config
    
    def _read_joy_output(self):
        joy_output = open(self.output_filepath, "r")
        exctracted_features = [] 
    ...
    def _extract_tls_clump_features(self, clumps):
        ...
        extracted_tls_clumped_features = {
            ...
            'bidirectional_stdev_tls_clump_bytes':            clump_bytes_stats.std_deviation(),
            ...
            'bidirectional_stdev_tls_clump_sizes':            clump_sizes_stats.std_deviation(),
        ...
        src2dst_extracted_tls_clumped_features = {
            ...
            'src2dst_stdev_tls_clump_bytes':            src2dst_clump_bytes_stats.std_deviation(),
            ...
            'src2dst_stdev_tls_clump_sizes':            src2dst_clump_sizes_stats.std_deviation(),
        ...
        dst2src_extracted_tls_clumped_features = {
            ...
            'dst2src_stdev_tls_clump_bytes':            dst2src_clump_bytes_stats.std_deviation(),
            ...
            'dst2src_stdev_tls_clump_sizes':            dst2src_clump_sizes_stats.std_deviation(),
    ...
    def _exctract_tls_record_features(self, records):
        ...
        src2dst_extracted_features = {
            ...
            'src2dst_stdev_tls_record_size':            src2dst_stats.std_deviation(),
        ...
        dst2src_extracted_features = {
            ...
            'dst2src_stdev_tls_record_size':            dst2src_stats.std_deviation(),
        ...
        bidirectional_extracted_features = {
            'bidirectional_tls_records': len(dst2src_tls_records),
            ...
            'bidirectional_stdev_tls_record_size':            bi_stats.std_deviation(),
...
if __name__ == '__main__':
    ...
    merged_df = TLSRecordJoy('./pcaps/DoH-Firefox84-NextDNS-1-pcap-format.pcap').execute_joy(df)
